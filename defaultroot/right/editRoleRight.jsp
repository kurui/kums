...
//--> 
	...
	<body class="body_m">
		...
		<c:import url="/page/mainTitle.jsp" charEncoding="UTF-8">
			...
			<c:param name="title2" value="用户角色权限设置" />
		</c:import>

		<table width="100%" height="45" class="table_sc">
			<tr>
				<td>
					<img src="../_img/btn_s.jpg" align="absmiddle" class="m_l_5 m_r_5" />
					用户角色：
					...
					<td valign="top">
						...
						<div style="margin-top: 5px;">
							<input type="button" class="button1"
								onclick="window.history.back();" value="返 回">
							<input type="button" class="button1" onclick="saveRight();"
								value="保 存">
