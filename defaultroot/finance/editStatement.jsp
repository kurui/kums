...
function submitForm()
{
  ...
  else if(confirm("请再次确认日期，金额无误！"))
  {
	...
	<body>
		<div>
			<html:form
				action="/finance/statement.do?thisAction=confirmStatement"
				method="post">
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0"
					...
					<tr>
						...
						<td>
							<c:if test="${statement.type==1}">
								<html:select property="toAccountId"
									value="${statement.toAccount.id}" styleId="accountId"
									name="statement" styleClass="colorblue2 p_5"
									style="width:200px;">
							...
							<c:if test="${statement.type==2}">
								<html:select property="fromAccountId"
									value="${statement.fromAccount.id}" styleId="accountId"
									name="statement" styleClass="colorblue2 p_5"
									style="width:200px;">
									<c:forEach items="${accountList}" var="account">
										<html:option value="${account.id}">
					...
					<tr>
						...
						<td>
							<html:text property="statementDate" name="statement"
					...
					<tr>
						...
						<td>
							<html:text property="totalAmount" name="statement"
								styleClass="text ui-widget-content ui-corner-all" />
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<html:radio property="status" value="0" name="statement" />
							未结算
							<html:radio property="status" value="1" name="statement" />
							已结算
							<html:radio property="status" value="8" name="statement" />
							已确认结算,不再修改
						</td>
					</tr>
					<tr>
						...
						<td>
							<html:text property="memo" name="statement"
								styleClass="text ui-widget-content ui-corner-all" />
						</td>
					</tr>
					<tr>
						<td colspan="2" class="center">
							<input value="提 交" type="button" onclick="submitForm()"
								class="button1">
							<input value="关 闭" type="button" onclick="closex();"
								class="button1">
						</td>
					</tr>
				</table>
