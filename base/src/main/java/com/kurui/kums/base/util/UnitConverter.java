...
public class UnitConverter {
	...
	public static void main(String[] args) {
		...
		System.out.println("big-->double:"+getDoubleByBigDecimal(aa));
	...
	public static Double getDoubleByBigDecimal(BigDecimal bigDecimalAmount) {
		String strAmount=getStringByBigDecimal(bigDecimalAmount);
		Double tempAmount = new Double(0);
		tempAmount = Double.valueOf(strAmount);
		return tempAmount;
	}
