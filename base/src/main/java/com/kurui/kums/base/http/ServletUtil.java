...
//			System.out.println("---------ServletUtil.isLocalHost:" + address);
	...
	public static String getServerRealPath(HttpServletRequest request, String para) throws ServletException{
		return request.getSession().getServletContext().getRealPath(para);
	}
