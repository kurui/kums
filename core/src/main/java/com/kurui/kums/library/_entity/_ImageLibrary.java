...
extends org.apache.struts.action.ActionForm implements Cloneable {
	...
	protected java.util.Set imageDependents = new HashSet(0);
	...
	public java.util.Set getImageDependents() {
		return imageDependents;
	}
	public void setImageDependents(java.util.Set imageDependents) {
		this.imageDependents = imageDependents;
	}
