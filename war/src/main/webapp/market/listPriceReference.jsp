						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../page/mainTitle.jsp" charEncoding="UTF-8">
									...
									<c:param name="title3" value="参考系数列表" />
								</c:import>
								...
								<div class="searchBar">
									<table cellpadding="0" cellspacing="0" border="0" class="searchPanel">
										<tr>
											...
											<td>
												<html:select property="type" value="${priceReferenceListForm.type}" styleClass="colorblue2 p_5" style="width:180px;">
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dataList">
									...
									<c:forEach var="priceReference" items="${priceReferenceListForm.list}" varStatus="status">
										<tr>
											<td>
												<html:multibox property="selectedItems" value="${priceReference.id}"></html:multibox>
											</td>
											<td>
												<c:out value="${status.count+(priceReferenceListForm.intPage-1)*priceReferenceListForm.perPageNum}" />
											</td>
											<td>
												<c:out value="${priceReference.code}" />
											</td>
											<td>
												<a href="<%=path%>/market/priceReferenceList.do?thisAction=view&id=<c:out value="${priceReference.id}" />"> <c:out value="${priceReference.name}" /> </a>
											</td>
											<td>
								...
								<table width="100%" style="margin-top: 5px;">
									<tr>
										...
										<td align="right">
											<div>
												共有记录&nbsp;
												<c:out value="${priceReferenceListForm.totalRowCount}"></c:out>
												&nbsp;条&nbsp;&nbsp;&nbsp;&nbsp; [
												<a href="JavaScript:turnToPage(document.forms[0],0)">首页</a> |
												<a href="JavaScript:turnToPage(document.forms[0],1)">上一页</a> |
												<a href="JavaScript:turnToPage(document.forms[0],2)">下一页</a> |
												<a href="JavaScript:turnToPage(document.forms[0],3)"> 末页</a>] 页数:
												<c:out value="${priceReferenceListForm.intPage}" />
												/
												<c:out value="${priceReferenceListForm.pageCount}" />
												]
											</div>
										</td>
									</tr>
