								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<tr>
										...
										<td style="text-align: left">
											<html:text property="name" name="platform"
												value="${platform.name}" styleClass="colorblue2 p_5"
									...
									<tr>
										...
										<td style="text-align: left">
											...
											<html:select property="type" name="platform"
									...
									<tr>
										...
										<td style="text-align: left">
											<html:text property="description" name="platform"
									...
									<tr>
										...
										<td style="text-align: left">
											...
											<html:select property="status" name="platform"
