...
<link  rel="stylesheet" type="text/css" href="featuresdemo.css"  />

<script type="text/javascript"
	src="<%=path%>/_js/swfupload/swfupload.js"></script>
<script type="text/javascript"
	src="<%=path%>/_js/swfupload/overlay/swfupload.queue.js"></script>
<script type="text/javascript" src="<%=path%>/_js/swfupload/overlay/swfupload.swfobject.js"></script>
<script type="text/javascript"
	src="<%=path%>/_js/swfupload/fileprogress.js"></script>
<script type="text/javascript" src="<%=path%>/_js/swfupload/overlay/handlers.js"></script>
<style type="text/css">
	.swfupload {
		position: absolute;
		z-index: 1;
