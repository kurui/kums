...
<script type="text/javascript"
	src="<%=path%>/_js/swfupload/simple/swfupload.queue.js"></script>
<script type="text/javascript"
	src="<%=path%>/_js/swfupload/simple/fileprogress.js"></script>
<script type="text/javascript" src="<%=path%>/_js/swfupload/simple/handlers.js"></script>
