				...
				<div class="sideBarItem webAdmin">
					<c:check code="ss01">
						...
						<ul class="contents" id="ulPCAccount" style="display: none">
							<li>
								<a href="<%=path%>/library/platComAccountList.do?thisAction=list" target="mainFrame">平台账号列表</a>
							</li>

							<li>
								<a href="<%=path%>/library/platformList.do?thisAction=list" target="mainFrame">交易平台列表</a>
							</li>
							<li>
								<a href="<%=path%>/library/companyList.do?thisAction=list&type=1" target="mainFrame">集团旗下公司列表</a>
							</li>
							<li>
								<a href="<%=path%>/library/paymentToolList.do?thisAction=list" target="mainFrame">支付工具列表</a>
							</li>
							<li>
								<a href="<%=path%>/library/accountList.do?thisAction=list&type=1&status=1" target="mainFrame">账号列表</a>
							</li>
						</ul>
					</c:check>
					...
					<ul class="contents" id="ulDataType">
						<li>
							<a href="<%=path%>/library/dataTypeList.do?thisAction=list&level=1" target="mainFrame">数据字典列表</a>
						</li>
					</ul>
					...
					<ul class="contents" id="ulSystemData">
						<li>
							<a href="<%=path%>/library/editSystemData.jsp" target="mainFrame">更新系统数据</a>
						</li>
					</ul>
					...
					<ul class="contents" id="ulLog" style="display: ''">
						<li>
							<a href="<%=path%>/monitor/loginloglist.do?thisAction=list&locate=2" target="mainFrame">登录日志</a>
						</li>
						<li>
							<a href="<%=path%>/monitor/operateLoglist.do?thisAction=list" target="mainFrame">操作日志</a>
						</li>
					</ul>
				</div>
			</div>
