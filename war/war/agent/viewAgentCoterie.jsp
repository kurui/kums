							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0"
								...
								<tr>
									...
									<td style="text-align: left"><c:out
											value="${agentCoterie.coterie.name}" /></td>
								</tr>
								<tr>
									<td class="lef"><c:out
											value="${agentCoterie.subAgent.agentNo}" /></td>
									<td style="text-align: left"><c:out
											value="${agentCoterie.subAgent.name}" /> | <c:out
											value="${agentCoterie.subAgent.typeInfo}" /></td>
								</tr>
								<tr>
									<td class="lef">加入时间</td>
									<td style="text-align: left"><c:out
											value="${agentCoterie.createDate}" /></td>
								</tr>
								<tr>
									<td class="lef">开始时间</td>
									<td style="text-align: left"><c:out
											value="${agentCoterie.fromDate}" /></td>
								</tr>
								<tr>
									<td class="lef">结束时间</td>
									<td style="text-align: left"><c:out
											value="${agentCoterie.expireDate}" /></td>
								</tr>
								<tr>
									<td class="lef">状态</td>
									<td style="text-align: left"><c:out
											value="${agentCoterie.statusInfo}" /></td>
								</tr>
							</table>
