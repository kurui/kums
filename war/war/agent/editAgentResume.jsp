								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<tr>
										...
										<td style="text-align: left">
											<c:out value="${agentResume.agent.agentNo}"></c:out>
											|
											<c:out value="${agentResume.agent.name}"></c:out>
											<html:hidden property="agentId"
												value="${agentResume.agent.id}" name="agentResume" />
										</td>
									</tr>
									<tr>
										<td class="lef">
									...
									<tr>
										...
										<td style="text-align: left">
											<html:select property="type" value="${agentResume.type}"
