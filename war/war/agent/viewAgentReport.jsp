								...
								<tr>
									<td valign="top">
										<table width="100%" cellpadding="0" cellspacing="0" border="0"
											...
											<c:forEach var="data" items="${typeList}" varStatus="status">
												<tr>
													<td><c:out value="${status.count}" /></td>
													<td><c:out value="${data.itemName}" /></td>
										...
										<table width="100%" cellpadding="0" cellspacing="0" border="0"
											...
											<c:forEach var="data" items="${sexList}" varStatus="status">
												<tr>
													<td><c:out value="${status.count}" /></td>
													<td><c:out value="${data.itemName}" /></td>
													<td><c:out value="${data.itemValue}" /></td>
										...
										<table width="100%" cellpadding="0" cellspacing="0" border="0"
											...
											<c:forEach var="data" items="${companyList}"
												...
												<tr>
													<td><c:out value="${status.count}" /></td>
													<td><a
														href="<%=path%>/agent/agentList.do?thisAction=view&id=<c:out value="${data.companyId}" />">
															<c:out value="${data.companyName}" />
													</a></td>
													<td><a
														href="<%=path%>/agent/agentResumeList.do?thisAction=list&companyId=<c:out value="${data.companyId}" />">
