							...
							<td valign="top" class="body">
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dataList">
									<tr>
										...
										<td style="text-align: left">
											<logic:equal value="checkOn" property="thisAction" name="accountCheck">
												<html:select property="accountId" name="accountCheck" styleClass="colorblue2 p_5" style="width:200px;">
									...
									<tr>
										...
										<td style="text-align: left">
											<html:text property="checkOnAmount" name="accountCheck" styleId="checkOnAmount" value="${accountCheck.checkOnAmount}" onkeyup="onkeyBalance();" styleClass="colorblue2 p_5"
										...
										<c:if test="${accountCheck.type==0 or accountCheck.type==1}">
											...
											<td style="text-align: left">
												<html:text property="transInAmount" name="accountCheck" styleId="transInAmount" value="${accountCheck.transInAmount}" onkeyup="onkeyBalance();" styleClass="colorblue2 p_5"
													style="width:200px;"></html:text>
											</td>
										</c:if>
									</tr>
									<c:if test="${accountCheck.type==0 or accountCheck.type==1}">
										<tr>
											...
											<td style="text-align: left">
												<html:text property="transOutAmount" name="accountCheck" styleId="transOutAmount" value="${accountCheck.transOutAmount}" onkeyup="onkeyBalance();" styleClass="colorblue2 p_5"
													style="width:200px;"></html:text>
											</td>
											<td class="lef">
												退回金额
											...
											<td style="text-align: left">
												<html:text property="refundAmount" name="accountCheck" styleId="refundAmount" value="${accountCheck.refundAmount}" onkeyup="onkeyBalance();" styleClass="colorblue2 p_5"
													style="width:200px;"></html:text>
											</td>
										</tr>
									</c:if>
									<tr>
										<c:if test="${accountCheck.type==0 or accountCheck.type==1}">
											...
											<td style="text-align: left">
												<html:text property="payAmount" name="accountCheck" styleId="payAmount" value="${accountCheck.payAmount}" onkeyup="onkeyBalance();" styleClass="colorblue2 p_5" style="width:200px;"></html:text>
											</td>
											<td class="lef">
												下班金额
											</td>
											<td style="text-align: left">
												<html:text property="checkOffAmount" name="accountCheck" styleId="checkOffAmount" value="${accountCheck.checkOffAmount}" onkeyup="onkeyBalance();" styleClass="colorblue2 p_5"
													style="width:200px;"></html:text>
											</td>
										</c:if>
									</tr>
									<tr>
										...
										<td style="text-align: left">
											<html:text property="note" name="accountCheck" value="${account.note}" styleClass="colorblue2 p_5" style="width:200px;"></html:text>
										</td>
									</tr>
									<logic:equal value="update" property="thisAction" name="accountCheck">
										<tr>
											...
											<td style="text-align: left">
												...
												<html:select property="status" name="accountCheck" styleClass="colorblue2 p_5" style="width:50px;">
								...
								<table width="100%" style="margin-top: 5px;">
									<tr>
										<td>
											...
											<input name="label" type="button" class="button1" value="保 存" onclick="add();">
