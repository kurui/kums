								...
								<div class="searchBar">
									<table cellpadding="0" cellspacing="0" border="0" class="searchPanel">
										<tr>
											...
											<td>
												<html:text property="accountName" styleClass="colorblue2 p_5" style="width:100px;"></html:text>
											</td>
											<td>
												操作员
											</td>
											<td>
												<html:text property="userNo" styleClass="colorblue2 p_5" style="width:100px;"></html:text>
											</td>
											<td>
												开始:
												<html:text property="startDate" styleClass="colorblue2 p_5" style="width:150px;"
													onfocus="WdatePicker({startDate:'%y-%M-%D 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" readonly="true" />
											</td>
											<td>
												结束
												<html:text property="endDate" styleClass="colorblue2 p_5" style="width:150px;" onfocus="WdatePicker({startDate:'%y-%M-%D 23:59:59',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"
													readonly="true" />
											</td>
											...
											<td>
												<input name="label" type="button" class="button1" value="上 班" onclick="add();">
											</td>
										</tr>
									</table>
								</div>
								<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dataList">
									...
									<c:forEach var="check" items="${aclf.list}" varStatus="status">
										<tr>
											...
											<td>
												<c:out value="${check.formatCheckOnTime}" />
											</td>
											<td>
												<c:out value="${check.formatCheckOffTime}" />
											</td>
											<td style="text-align: left">
