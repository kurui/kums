...
<script type="text/javascript" language="javascript"
	src="<%=path%>/_js/base/menu.js"></script>
<c:if test="${URI==null}">
		...
		<div id="sideBar">
			<div class="sideBarItem webAdmin">
				<span class="title"><a href="#"
					onclick="showUL('ulInformation')">流程引擎服务</a> </span>
				<ul class="contents" id="ulInformation" style="">
					<li><a href="../workflow/workflowList.do" target="mainFrame">流程建模</a>
					</li>
					<li><a href="../workflow/workflowList.do" target="mainFrame">流程引擎</a>
					</li>
					<li><a href="../workflow/workflowList.do?thisAction=listTask"
				...
				<span class="title"><a href="#" onclick="showUL('ulLicense')">授权管理</a></span>
				<ul>
					<li class="contents" id="ulLicense"><a
						href="<%=path%>/right/licenseList.do?thisAction=list&status=1"
						target="mainFrame">授权列表</a></li>
				</ul>


				<span class="title"><a href="#"
					onclick="showUL('ulImageLibrary')">资源库管理</a></span>
				<ul class="contents" id="ulImageLibrary">
					<li><a
						href="<%=path%>/library/imageDependentList.do?thisAction=list"
						target="mainFrame">图片库</a></li>
				</ul>


				<span class="title"><a href="#"
					onclick="showUL('ulOutInterface')">外部系统服务</a> </span>
				<ul class="contents" id="ulOutInterface" style="">
					<li><a href="#" target="mainFrame">电子邮件</a></li>
					<li><a href="#" target="mainFrame">短信平台</a></li>
				</ul>
