						...
						<tr>
							...
							<td valign="top" class="body">
								...
								<div class="searchBar">
									<table cellpadding="0" cellspacing="0" border="0"
										...
										<tr>
											...
											<td>
												<html:text property="no" styleClass="colorblue2 p_5"
													style="width:120px;" />
											</td>
											<td>
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<c:forEach var="budget" items="${budgetListForm.list}"
										varStatus="status">
										<tr>
											<td>
												<html:multibox property="selectedItems" value="${budget.id}"></html:multibox>
											</td>
											<td>
											...
											<td style="text-align: left">
												...
												<a
													href="<%=path%>/finance/budgetList.do?thisAction=view&id=<c:out value="${budget.id}" />">
													<c:out value="${budget.name}" /> </a>
											...
											<td>
												<c:out value="${budget.totalStatementAmount}" />
											</td>
											<td>
								...
								<table width="100%" style="margin-top: 5px;">
									<tr>
										...
										<td align="right">
											<div>
												共有记录&nbsp;
												<c:out value="${budgetListForm.totalRowCount}"></c:out>
												&nbsp;条&nbsp;&nbsp;&nbsp;&nbsp; [
												...
												页数:
												<c:out value="${budgetListForm.intPage}" />
												/
												<c:out value="${budgetListForm.pageCount}" />
												]
											</div>
										</td>
									</tr>
