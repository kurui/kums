...
.agentBoxDiv {
	...
	<script type="text/javascript">	
		...
		function addAgentSpeed(){
			openWindow(800,600,'../finance/agentList.do?thisAction=saveSpeed');		
		}
	</script>
	<body>
		<c:import url="../page/mainTitle.jsp" charEncoding="UTF-8">
			<c:param name="title1" value="财务管理" />
			<c:param name="title2" value="编辑资产项目" />
		</c:import>
							...
							<td valign="top" class="body">
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<tr>
										...
										<td style="text-align: left">
											<html:hidden property="agentId"
												value="${assetsItem.agent.id}" name="shareHolder" />
											<html:text property="agentNo"
												value="${assetsItem.agent.agentNo}|${assetsItem.agent.name}" name="shareHolder"
										...
										<td style="text-align: left">
											<html:select property="status" value="${assetsItem.status}"
									...
									<tr>
										...
										<td style="text-align: left">
											<html:text property="carNo" value="${assetsItem.carNo}"
												name="assetsItem" styleClass="colorblue2 p_5"
												style="width:120px;" />
											车型
											<html:text property="carType" value="${assetsItem.carType}"
												name="assetsItem" styleClass="colorblue2 p_5"
												style="width:80px;" />
										</td>
										<td class="lef">
										...
										<td style="text-align: left">
											<html:text property="seatCount" value="${assetsItem.seatCount}"
												name="assetsItem" styleClass="colorblue2 p_5"
												style="width:80px;" />

											颜色
											<html:text property="color" value="${assetsItem.color}"
												name="assetsItem" styleClass="colorblue2 p_5"
												style="width:80px;" />
										</td>
									</tr>
									<tr>
										...
										<td style="text-align: left">
											<html:text property="engineNo" value="${assetsItem.engineNo}"
												name="assetsItem" styleClass="colorblue2 p_5"
												style="width:120px;" />
										</td>
										<td class="lef">
										...
										<td style="text-align: left">
											<html:text property="carcaseNo" value="${assetsItem.carcaseNo}"
												name="assetsItem" styleClass="colorblue2 p_5"
												style="width:120px;" />
										</td>
									</tr>
									<tr>
										...
										<td style="text-align: left" colspan="3">
											<html:text property="memo" name="assetsItem"
												value="${assetsItem.memo}" styleClass="colorblue2 p_5"
								...
								<table width="100%" style="margin-top: 5px;">
									<tr align="center">
										<td>
											<html:hidden property="id" name="assetsItem"></html:hidden>
											<html:hidden property="thisAction" name="assetsItem" />
