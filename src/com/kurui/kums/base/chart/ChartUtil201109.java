...
import com.kurui.kums.base.chart.test.TestServlet;
import com.kurui.kums.base.file.FileUtil;

public class ChartUtil201109 {
	 ...
	 * @return
	 */
	public static String createTimeXYChar(CategoryDataset xyDataset,
		...
		// Lable  
//		domainAxis.setCategoryLabelPositions(CategoryLabelPositions.UP_45); // 横轴上的 45度倾斜		
...
//					info, session);
//			String graphURL=TestServlet.test1(request, response);
...
//			request.setAttribute("graphURL", graphURL);
			...
			try {
				fos_jpg.close();
				System.out.println("create time-createTimeXYChar."+chartPath+charName);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
